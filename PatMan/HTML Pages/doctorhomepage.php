...
<body>
    ...
    <main>
        ...
        <section class="pat_head">
            <form action="" method="post" class="search" name="search_form">
        ...
        <div class="pat_list" id="pat_list">
            ...
            ?>
                ...
                <div class="inner"></div>
                    ...
                    <?php 
                    if($row['pat_gender']=='male'):
                    ?>
                    <img src="Assets/male_user_icon.png" alt="doctor_icon" height="130" width="130">
                    <?php elseif($row['pat_gender']=='female'): ?>
                    <img src="Assets/female_user_icon.png" alt="doctor_icon" height="130" width="130">
                    <?php else: ?>
                    <img src="Assets/user_icon.png" alt="doctor_icon" height="130" width="130">
                    <?php endif; ?>
    ...
    <div class="add_pat" id="pop_up">
        ...
        <form method="post" name="mainForm">
            ...
            <input type="text" id="contact" name="contact" autocomplete="off" minlength="10" maxlength="10" title="please enter 10 digit contact number." required>
